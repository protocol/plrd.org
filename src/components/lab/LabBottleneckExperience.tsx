...
import { DemoCommunityPanel, useDemoCommunity } from '@/components/lab/demo';
...
function OwnedBottleneck({ owner }: { owner: string }) {
  ...
  return <>
    {known && isDemo && <div className="lab-wrap"><details className="bottleneck-community-drawer" open={storyOnly}><summary>Discussion and collaborators <small>Illustrative community story</small></summary><DemoCommunityPanel className="lab-community-supplement" context="bottleneck" caseId={caseId as DemoCaseId} showPeople /></details></div>}
