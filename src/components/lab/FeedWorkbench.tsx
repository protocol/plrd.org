...
export default function FeedWorkbench() {
  ...
  return <div className={styles.root}>
    <header className={styles.workshopHeader} aria-label="Workshop invitation"><div><h1>The workshop</h1><p>Made something that makes science easier?</p></div><button className="lab-button lab-quiet" aria-label="What are you making? Show a build →" onClick={() => setCompose(true)}>Show a build →</button></header>
