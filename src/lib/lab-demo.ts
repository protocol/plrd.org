...
export const DEMO_PEOPLE: readonly DemoPerson[] = [
  { id: 'mira', name: 'Mira Sen', initials: 'MS', role: 'Research software maintainer', bio: 'In this story, Mira turns evaluation notebooks into inspectable workflows. She would rather keep a failing test than hide a weak result.', lookingFor: 'A second reader for a split-and-fit checklist.', caseIds: ['reproducibility', 'open-artifacts'], fictional: true },
  { id: 'ellis', name: 'Ellis Vale', initials: 'EV', role: 'Methods reviewer', bio: 'Ellis asks whether a proposed test can distinguish the explanation from its alternatives. Skepticism is a contribution, not a veto.', lookingFor: 'A counterexample that survives the proposed audit.', caseIds: ['reproducibility'], fictional: true },
  { id: 'jo', name: 'Jo Arden', initials: 'JA', role: 'Independent reproducibility engineer', bio: 'Jo keeps small execution logs and writes down what could not be reproduced, including missing dependencies.', lookingFor: 'Someone to rerun the revised toy example independently.', caseIds: ['reproducibility', 'open-artifacts'], fictional: true },
  { id: 'sana', name: 'Sana Iven', initials: 'SI', role: 'Neural data steward', bio: 'Sana works through units, recording duration, and dataset boundaries before putting measurements on the same chart.', lookingFor: 'A reviewer for simultaneous versus sequential recording definitions.', caseIds: ['neural-measurement'], fictional: true },
  { id: 'tomas', name: 'Tomas Reed', initials: 'TR', role: 'Measurement-tool designer', bio: 'Tomas prototypes small evidence forms. He prefers an explicit unknown to a precise number with an ambiguous denominator.', lookingFor: 'An example where two reasonable duration definitions disagree.', caseIds: ['neural-measurement', 'open-artifacts'], fictional: true },
  { id: 'nia', name: 'Nia Calder', initials: 'NC', role: 'Open artifact librarian', bio: 'Nia checks whether an artifact can be found, understood, and reused without assuming an open link is an open license.', lookingFor: 'A license-aware reader to test a minimal reuse receipt.', caseIds: ['open-artifacts'], fictional: true },
];
...
export const DEMO_NOTIFICATIONS = [
  { id: 'revision-ready', actorId: 'mira', threadId: 'split-boundary', label: 'Mira narrowed the leakage check after a false alarm.', action: 'Inspect the revised test', href: demoThreadHref('split-boundary') },
  { id: 'denominator-help', actorId: 'sana', threadId: 'duration-denominator', label: 'Sana kept an unknown instead of estimating missing hours.', action: 'Review the evidence gap', href: demoThreadHref('duration-denominator') },
  { id: 'receipt-blocker', actorId: 'nia', threadId: 'receipt-permission', label: 'Nia removed the green badge from the reuse receipt.', action: 'Read the design revision', href: demoThreadHref('receipt-permission') },
];
