...
test('Atlas namespace declares a defense-in-depth route header', async () => {
  assert.equal(typeof config.headers, 'function', 'scoped response-header policy must be configured')
